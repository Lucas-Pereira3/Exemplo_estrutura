            ...
            <div className="flex w-full max-w-5xl bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="hidden lg:block lg:w-1/2 relative bg-gray-200">
                    ...
                    <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-white p-8">
                        <h2 className="text-2xl font-bold text-center">Bem-vindo ao Ofiador</h2>
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="password"
                                required
                                placeholder={isLogin ? "Digite sua senha" : "Crie sua senha (mínimo 6 caracteres)"}
                        ...
                        <div className="text-center">
                            <button
                                ...
                                onClick={() => {
                                    setIsLogin(!isLogin);
                                    // Limpar formulário ao trocar modo
                                    setFormData({
                                        email: '',
                                        senha: '',
                                        nome: '',
