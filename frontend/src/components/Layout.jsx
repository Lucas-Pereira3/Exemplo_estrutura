    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-72">
                <div className="flex flex-col flex-1" style={{ backgroundColor: '#1A2B4C' }}>
                    <div className="flex flex-col items-center justify-center pt-6 pb-2 px-4 border-b" style={{ borderColor: '#2A3E64' }}>
                        <div className="mb-0">
                            <img
                                src={logo1}
                    ...
                    <div className="px-4 py-6 border-t" style={{ borderColor: '#2A3E64' }}>
            ...
            <div className="lg:hidden">
                <div className="fixed top-0 left-0 right-0 z-20" style={{ backgroundColor: '#1A2B4C' }}>
                ...
                {sidebarOpen && (
                    <div className="fixed inset-0 z-30 lg:hidden">
                        ...
                        <div className="fixed inset-y-0 left-0 w-72 shadow-xl" style={{ backgroundColor: '#1A2B4C' }}>
                            <div className="flex flex-col h-full">
                                <div className="flex flex-col items-center justify-center pt-8 pb-6 px-4 border-b" style={{ borderColor: '#2A3E64' }}>
                                    <div className="mb-0">
                                        <img
                                            src={logo1}
                                            alt="Logo Fiador"
